...
printf "BLEU = %.2f, %.2f (BP=%.3f, ratio=%.3f, hyp_len=%d, ref_len=%d)\n",
    100*$bleu,
    100*$bleu[1],
    $brevity_penalty,
...
# $bleu = $brevity_penalty * exp((my_log( $bleu[1] ) +
#                 my_log( $bleu[2]))/2);
# printf "BLEU = %.2f, %.2f/%.2f (BP=%.3f, ratio=%.3f, hyp_len=%d, ref_len=%d)\n",
#     100*$bleu,
#     100*$bleu[1],
#     100*$bleu[2],
#     $brevity_penalty,
...
#                 my_log( $bleu[2] ) +
#                 my_log( $bleu[3] )) / 3) ;
# printf "BLEU = %.2f, %.2f/%.2f/%.2f (BP=%.3f, ratio=%.3f, hyp_len=%d, ref_len=%d)\n",
#     100*$bleu,
#     100*$bleu[1],
#     100*$bleu[2],
#     100*$bleu[3],
